...
namespace FelicitySecurity.Services.Data.Repository
{
    ...
    /// </summary>
    public class FelicitySecurityUnitTestingRepositoryBase : IDisposable, IFelicitySecurityUnitTestingRepositoryBase
    {
        #region Variables
        ...
        public FelicitySecurityUnitTestingRepositoryBase(RepositoryCommitMode commitMode)
        {
        ...
        public FelicitySecurityUnitTestingRepositoryBase(DbConnection connection)
        {
            FetchChildObjects = true;
        ...
        public FelicitySecurityUnitTestingRepositoryBase(string connectionString)
        {
            FetchChildObjects = true;
            CommitMode = RepositoryCommitMode.Auto;
        ...
        public FelicitySecurityUnitTestingRepositoryBase(DbConnection connection, RepositoryCommitMode commitMode)
        {
            FetchChildObjects = true;
            CommitMode = commitMode;
            _connection = connection;
        ...
        void IFelicitySecurityUnitTestingRepositoryBase.FelicitySecurityRepositoryBase()
        {
            FetchChildObjects = true;
            CommitMode = RepositoryCommitMode.Auto;
        }

        void IFelicitySecurityUnitTestingRepositoryBase.FelicitySecurityRepositoryBase(RepositoryCommitMode commitMode)
        {
            FetchChildObjects = true;
            CommitMode = commitMode;
        }

        void IFelicitySecurityUnitTestingRepositoryBase.FelicitySecurityRepositoryBase(DbConnection connection)
        {
            FetchChildObjects = true;
            CommitMode = RepositoryCommitMode.Auto;
            _connection = connection;
        ...
        void IFelicitySecurityUnitTestingRepositoryBase.FelicitySecurityRepositoryBase(string connectionString)
        {
            FetchChildObjects = true;
            CommitMode = RepositoryCommitMode.Auto;
            _connectionString = connectionString;
        ...
        DbContext IFelicitySecurityUnitTestingRepositoryBase.GetDBContext()
        {
            if (DbContextType == null)
            {
                throw new InvalidOperationException(string.Format("DbContextType cannot be null"));
        ...
        bool IFelicitySecurityUnitTestingRepositoryBase.TrySaveChanges(DbContext dbContext)
        {
            try
            {
                if (CommitMode == RepositoryCommitMode.Auto)
        ...
        bool IFelicitySecurityUnitTestingRepositoryBase.SaveChanges()
        {
            return SaveChanges(_dbContext);
        }

        bool IFelicitySecurityUnitTestingRepositoryBase.SaveChanges(DbContext dbContext)
        {
            try
            {
                if (dbContext != null)
